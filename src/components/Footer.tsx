...
const siteDirectory = {
  ...
  flagship: [
    { label: 'Kaluwara', to: '/products/colours/lite/kaluwara' },
    { label: 'Africa Teak', to: '/products/colours/lite/africa-teak' },
    { label: 'Storm Grey', to: '/products/colours/heavy-b/storm-grey' },
    { label: 'Cream Satin', to: '/products/colours/heavy-f/cream-satin' },
